...
export default function Post({post}:PostProps){
    const [isLiked, setIsLiked] = useState<boolean | null>(post.isLiked);
    const [likesCount,setLikesCount] = useState(post.likes);
    const [commentsCount,setCommentsCount] = useState(post.comments);
    const [showComments,setShowComments]=useState(false);
    const [isBookmarked,setIsBookmarked] = useState<boolean|null>(post.isBookmarked);
    ...
    return(
        <View style={styles.post}>
            <View style={styles.postHeader}>
                ...
                {post.author._id === currentUser?._id?( <TouchableOpacity onPress={handleDelete}>
